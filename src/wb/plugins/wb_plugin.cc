...
void WBPlugin::onUpdate(const common::UpdateInfo &inf) {
  ...
  double lEff = 0;  // you might want to change this
...
void WBPlugin::Load(physics::ModelPtr _model, sdf::ElementPtr _sdf) {
  ...
  // STEP 2: Make sub subscribe to subName,
  //         using the function onCmd to handle messges
  //         Hint: Check out node->subscribe()
